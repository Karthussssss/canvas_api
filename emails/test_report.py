#!/usr/bin/env python3
"""
Script to generate a test HTML report from Notion grades data
For quick previewing of the report format and content
"""
...
def main():
    """Generate a test HTML report from Notion grades data"""
    # Define file paths
